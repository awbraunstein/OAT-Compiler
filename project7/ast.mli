...
type 'a stmt =
  ...
  | IfNull of ref * 'a id * 'a exp * 'a stmt * 'a opt_stmt
  | Cast of cid * 'a id * 'a exp * 'a stmt * 'a opt_stmt
...
type 'a efdecl = typ option * 'a id * 'a args
type 'a cdecl = cid * cid option * 'a fields * 'a ctor * 'a fdecls
...
type contexts = context list
type ptyp = Ptyp of typ | Pftyp of ftyp
type dcontext = (string * ftyp) list
