...
type
'a init = Iexp of 'a exp | Iarray of 'a * (('a init) list)
...
type
'a efdecl = (typ option) * ('a id) * ('a args)


type
'a cdecl = cid * cid option * ('a fields) * ('a ctor) * ('a fdecls)
...
type
'a gdecl = Gvdecl of 'a vdecl | Gfdecl of 'a fdecl | Gefdecl of 'a efdecl | Gcdecl of 'a cdecl
