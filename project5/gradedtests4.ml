...
let test_path = ref "../project4/tests/"
...
let comp_test ?ast2cpp:(ast2cpp=true) ?il2c:(il2c=true)
...
let file_test ?ast2cpp:(ast2cpp=true) ?il2c:(il2c=true) 
  ...
  let _ = close_in buffer in
    comp_test ~ast2cpp:ast2cpp ~il2c:il2c prog args ans ()

let file_error_test ?ast2cpp:(ast2cpp=true) ?il2c:(il2c=true) 
  ...
  let _ = close_in buffer in
  try
    (comp_test ~ast2cpp:ast2cpp ~il2c:il2c prog args "" ());
    failwith 
...
let typechecking_tests : suite = [
  GradedTest("Typechecking error tests4", 20, [   
...
let file_tests : suite = [
  ...
  GradedTest("Runtime error tests4", 20, [   
    ("run4", file_test ~ast2cpp:false "run4.oat" "" "Out-of-bound.");
    ("run6", file_test ~ast2cpp:false "run6.oat" "" "Out-of-bound.");
    ("run7", file_test ~ast2cpp:false "run7.oat" "" "Out-of-bound.");
    ("lib12", file_test ~ast2cpp:false "lib12.oat" "" "Out-of-bound.");
    ("run17", file_test ~ast2cpp:false "run17.oat" "" "Out-of-bound."); 
    ("run36", file_test ~ast2cpp:false "run36.oat" "" "Out-of-bound."); 
    ("run37", file_test ~ast2cpp:false "run37.oat" "" "Out-of-bound."); 
    ("lib15", file_test ~ast2cpp:false "lib15.oat" "" "Out-of-bound.");
  ]);
