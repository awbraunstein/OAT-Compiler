...
fdecl:
  | typ IDENT LPAREN arglist RPAREN LBRACE block RETURN exp SEMI RBRACE { (Some $1, $2, $4, $7, Some $9) }
  | TUNIT IDENT LPAREN arglist RPAREN LBRACE block RETURN SEMI RBRACE { (None, $2, $4, $7, None) }
...
E12:
  | const { Const $1 }
  | THIS  { This $1 }
  | NEW LBRACKET exp RBRACKET LPAREN FUN IDENT ARROW exp RPAREN { New ($3, $7, $9) }
